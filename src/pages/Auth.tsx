        ...
        <CardHeader className="text-center">
          <div className="flex justify-center mb-4">
            <div className="bg-white p-3 rounded-full shadow-lg">
              <img src="/lovable-uploads/69878f6a-055d-47cf-953a-4872955aa2e5.png" alt="Amplie Lion Icon" className="h-12 w-12 object-contain" />
            </div>
          </div>
          <div className="flex justify-center mb-2">
            <img src="/lovable-uploads/3b942df5-c321-4ec0-ac1e-6e82d2ee21d1.png" alt="Amplie Chat Logo" className="h-8 object-contain" />
          </div>
          <CardDescription>
