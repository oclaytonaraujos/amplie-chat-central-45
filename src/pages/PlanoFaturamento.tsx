...
export default function PlanoFaturamento() {
  ...
  const limites = [
    { recurso: 'Usuários', usado: 8, limite: 25 },
    { recurso: 'Contatos', usado: 1250, limite: 5000 },
    { recurso: 'Atendimentos/mês', usado: 340, limite: 1000 },
    { recurso: 'Armazenamento', usado: 2.5, limite: 10, unidade: 'GB' }
  ];
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div
                      className={`h-2 rounded-full ${
                        isQuaseEsgotado ? 'bg-red-500' : 'bg-amplie-primary'
                      }`}
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <Button
                    variant="outline"
                    size="sm"
                    onClick={() => window.open(fatura.downloadUrl, '_blank')}
                  >
