        ...
        <div className="p-2">
          {activeTab === 'contatos' ? (
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        ...
                        <div className="relative flex-shrink-0">
                          ...
                          <div className={`absolute -bottom-0.5 -right-0.5 w-3 h-3 rounded-full border-2 border-white ${getStatusColor(usuario.status)}`} />
                        </div>
            ...
            <div className="space-y-3">
              ...
              <div
                className="p-3 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors border-2 border-dashed border-gray-200"
              >
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3 className="text-sm font-medium text-gray-700">Criar Novo Grupo</h3>
                    <p className="text-xs text-gray-500">Adicione colegas ao grupo</p>
                  </div>
                </div>
              </div>

              {/* Grupos existentes (mockados) */}
              <div className="p-3 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors">
                <div className="flex items-center space-x-3">
                  <div className="w-10 h-10 bg-gradient-to-r from-green-500 to-green-600 rounded-full flex items-center justify-center">
                    <Users className="w-5 h-5 text-white" />
                  </div>
                  <div>
                    <h3 className="text-sm font-medium text-gray-900">Equipe Vendas</h3>
              ...
              <div className="p-3 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3 className="text-sm font-medium text-gray-900">Suporte Técnico</h3>
