  ...
  return (
    <header 
      className={`
        ...
        mt-2 sm:mt-4
        ${isScrolled 
          ? 'bg-white/95 dark:bg-gray-800/95 backdrop-blur-md shadow-lg border border-gray-200/50 dark:border-gray-700/50' 
        ...
        <div className="flex items-center space-x-2 sm:space-x-4 min-w-0 flex-1">
          {showMenuButton && (
            <Button 
              ...
              size="icon" 
              onClick={onMenuClick}
              className="shrink-0 touch-manipulation active:scale-95 transition-transform duration-150 hover:bg-gray-100 dark:hover:bg-gray-700 p-2 h-9 w-9 sm:h-10 sm:w-10"
          ...
          <div className="flex items-center space-x-2 sm:space-x-3 min-w-0 flex-1">
            {icon && (
              <div className="shrink-0 p-2 sm:p-3 bg-gray-100 dark:bg-gray-700 rounded-lg">
                <div className="w-4 h-4 sm:w-6 sm:h-6 text-gray-600 dark:text-gray-300">
                  {icon}
                </div>
              </div>
            )}
