        ...
        <div className="flex items-center space-x-2 sm:space-x-4 min-w-0 flex-1">
          {showMenuButton && (
            <Button 
              ...
              size="icon" 
              onClick={onMenuClick}
              className="shrink-0 touch-manipulation active:scale-95 transition-transform duration-150 hover:bg-gray-100 p-2 h-9 w-9 sm:h-10 sm:w-10"
          ...
          <div className="flex items-center space-x-2 sm:space-x-3 min-w-0 flex-1">
            {icon && (
              <div className="shrink-0 p-2 sm:p-3 bg-gray-100 rounded-lg">
            ...
            <div className="min-w-0 flex-1">
              ...
              {description ? (
                ...
                <p className="text-xs sm:text-sm text-gray-500 mt-0.5 sm:mt-1 truncate hidden sm:block">
